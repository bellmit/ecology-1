...
public class SSEWorkflow_280_action extends BaseBean implements Action {
    public String execute(RequestInfo request){
        ...
        try{
            ...
            try {
	            ...
	            writeLog("003管理类项目采购_专题采购 流程出错："+e1);
			}//回滚
            return "0";
        }finally{            
    		try {                
    			...
    			writeLog("003管理类项目采购_专题采购JDBC数据源close失败！"); 
    		}        
    	}
    }
    //生成合同编号
    ...
    public Connection conn(){
    	...
    	try{            
    		...
    		writeLog("003管理类项目采购_专题采购JDBC数据源初始化失败！");   
    		return conn;     
    	}
    }
}
