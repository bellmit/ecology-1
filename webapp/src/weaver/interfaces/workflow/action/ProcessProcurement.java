...
public class ProcessProcurement  extends BaseBean implements Action {
...
public String execute(RequestInfo request){
	  try{
            ...
            rs.executeSql("select a.id as ZBid,b.* from formtable_main_120 a,formtable_main_120_dt1 b where a.id=b.mainid and a.requestid = "+requestid );
            while(rs.next()){
				...
				//为日志打印准备
				String Worlds=SUPPLIER+"____"+je;
...
writeLog("进入5_往OA的formtable_main_120_dt1明细表内回写UUID_开始____"+uuid4);
							RecordSet rs2 = new RecordSet();
							String sql1 ="update formtable_main_120_dt1 set ";
							if(!"".equals(uuid4)){
