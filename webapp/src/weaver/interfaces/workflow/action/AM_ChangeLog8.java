...
public class AM_ChangeLog8 extends BaseBean
implements Action
{
public String execute(RequestInfo request)
{
  try
  {
    ...
    String sql="";
    sql="select b.assetname,a.creator from uf_am_allocation a,uf_am_allocation_dt1 b where a.id=b.mainid and a.requestid="+billid;
    rs.executeSql(sql);
    while (rs.next()) {     
    	String  title="低值易耗品分配";//变更事项      	
      ...
      writeLog("低值易耗品变更记录8--结束");
    }    
  }
  catch (Exception e) {
    writeLog("低值易耗品变更记录8--出错" + e);
    return "0";
  }
  return "1";
 }
