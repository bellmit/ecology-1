...
public class SPM_Xmcg2 extends BaseBean
  implements Action
{
  public String execute(RequestInfo request)
  {
    try
    {
      ...
      String sql="select a.sqr,a.sqrbm,b.htmc,b.je,b.htqdrq,b.htqsrq,b.htjzrq,b.htsmj,b.supplier,b.agentsupplier from formtable_main_120 a,formtable_main_120_dt1 b where a.id=b.mainid and b and a.requestid="+billid;
      rs.executeSql(sql);
      while (rs.next()) {
    	  ...
    	  if(!agentsupplier.equals("")){
        	...
        	UUID uuid = UUID.randomUUID();
          	...
          	+"supplier,createdate,creator,dept,contractflow,contractname,money,signdate,begindate,enddate,uuid) values ("+modeId+",1,0,convert(varchar(10),getdate(),120),convert(varchar(8),getdate(),108),"
          ...
          writeLog("采购流程生成供应商合同数据--成功");
       }      
    }
    catch (Exception e) {
      writeLog("采购流程生成供应商合同数据--出错" + e);
      return "0";
    }
    return "1";
  }
