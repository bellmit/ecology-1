...
public class AM_ChangeLog3 extends BaseBean
implements Action
{
public String execute(RequestInfo request)
{
  try
  {
    ...
    String sql="";
    sql="select b.assetname,a.creator from uf_am_assetreturn a,uf_am_assetreturn_dt1 b where a.id=b.mainid and a.requestid="+billid;
    rs.executeSql(sql);
    while (rs.next()) {     
      ...
      writeLog("固定资产变更记录3--结束");
    }    
  }
  catch (Exception e) {
    writeLog("固定资产变更记录3--出错" + e);
    return "0";
  }
  return "1";
 }
