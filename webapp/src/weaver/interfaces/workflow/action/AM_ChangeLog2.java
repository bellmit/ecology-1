...
public class AM_ChangeLog2 extends BaseBean
implements Action
{
public String execute(RequestInfo request)
{
  try
  {
    ...
    String sql="";
    sql="select b.assetname,a.creator from uf_am_assetapply a,uf_am_assetapply_dt1 b where a.id=b.mainid and a.requestid="+billid;
    rs.executeSql(sql);
    while (rs.next()) {     
    	String  title="资产领用";//变更事项      	
      ...
      writeLog("固定资产变更记录2--结束");
    }    
  }
  catch (Exception e) {
    writeLog("固定资产变更记录2--出错" + e);
    return "0";
  }
  return "1";
 }
