...
public class AM_ChangeLog10 extends BaseBean
implements Action
{
public String execute(RequestInfo request)
{
  try
  {
    ...
    String sql="";
    sql="select b.assetname,a.creator from 	uf_am_batchreturn a,uf_am_batchreturn_dt1 b where a.id=b.mainid and a.requestid="+billid;
    rs.executeSql(sql);
    while (rs.next()) {     
    	String  title="资产归还";//变更事项      	
      ...
      writeLog("固定资产批量归还变更记录10--结束");
    }    
  }
  catch (Exception e) {
    writeLog("固定资产批量归还变更记录10--出错" + e);
    return "0";
  }
  return "1";
 }
