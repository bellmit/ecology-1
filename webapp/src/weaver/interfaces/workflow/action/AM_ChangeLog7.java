...
public class AM_ChangeLog7 extends BaseBean
implements Action
{
public String execute(RequestInfo request)
{
  try
  {
    ...
    String sql="";
    sql="select b.id,a.creator from uf_am_artcles a,uf_am_articles b where a.requestid=b.flowid and a.requestid="+billid;
    rs.executeSql(sql);
    while (rs.next()) {     
    	String  title="低值易耗品入库";//变更事项      	
      ...
      writeLog("低值易耗品变更记录7--结束");
    }    
  }
  catch (Exception e) {
    writeLog("低值易耗品变更记录7--出错" + e);
    return "0";
  }
  return "1";
 }
