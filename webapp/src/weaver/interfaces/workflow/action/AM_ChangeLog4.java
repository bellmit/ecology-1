...
public class AM_ChangeLog4 extends BaseBean
implements Action
{
public String execute(RequestInfo request)
{
  try
  {
    ...
    String sql="";
    sql="select assetname,creator from uf_am_assetupdate  where requestid="+billid;
    rs.executeSql(sql);
    if (rs.next()) {     
    	String  title="资产部门内变更";//变更事项      	
      ...
      writeLog("固定资产变更记录4--结束");
    }    
  }
  catch (Exception e) {
    writeLog("固定资产变更记录4--出错" + e);
    return "0";
  }
  return "1";
 }
