...
public class AM_ChangeLog6 extends BaseBean
implements Action
{
public String execute(RequestInfo request)
{
  try
  {
    ...
    String sql="";
    sql="select b.assetname,a.creator,(select selectname from workflow_SelectItem where fieldid=10969 and selectvalue=a.dealtype) as dealtype from uf_am_assetdeal a,uf_am_assetdeal_dt1 b where a.id=b.mainid and a.requestid="+billid;
    rs.executeSql(sql);
    while (rs.next()) {     
    	String  title="资产"+Util.null2String(rs.getString("dealtype"));//变更事项      	
